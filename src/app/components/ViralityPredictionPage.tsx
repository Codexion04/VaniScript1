import { TrendingUp, Flame, Users, Heart, Share2, Eye } from "lucide-react";
...
export function ViralityPredictionPage() {
  ...
  useEffect(() => {
    ...
    if (savedScore) setViralScore(parseInt(savedScore));
    if (savedReach) setReach(savedReach);
    if (savedEngagement) setEngagement(savedEngagement);
    if (savedShares) setShares(savedShares);
    if (savedImpressions) setImpressions(savedImpressions);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {insights.map((insight, index) => (
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg border p-6"
          >
